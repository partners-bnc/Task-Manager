...
import { LayoutDashboard, ListTodo, PlusSquare, Users, LogOut, Camera, ChevronLeft, ChevronRight } from 'lucide-react';
...
export default function Sidebar({ currentView, onNavigate, isCollapsed = false, onToggleCollapse }) {
  ...
  const menuItems = [
    ...
    ...(isAdminMode ? [{ label: 'Create Task', icon: PlusSquare, view: 'create-task' }] : []),
