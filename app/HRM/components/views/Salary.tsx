                ...
                <tbody className="divide-y divide-outline-variant/10">
                  {loading ? (
                    ...
                    items.map((item) => (
                      <tr
                        key={item.id}
                        className={`transition-colors hover:bg-surface-container-low/30 ${selectedMonth?.id === item.id ? 'bg-emerald-50/70' : ''
                          }`}
                      >
                    ...
                    {selectedMonth?.payslipReleased && selectedMonth?.payslip?.snapshot_json ? (
                      <div className="flex flex-wrap gap-2">
                        ...
                        <button
                          ...
                          className="rounded-full border border-violet-200 bg-[linear-gradient(180deg,#edf4fc_0%,#d7e7f9_100%)] px-5 py-2.5 text-sm font-semibold text-violet-950 shadow-[0_10px_20px_rgba(49,112,197,0.18)] transition hover:-translate-y-0.5 hover:shadow-[0_14px_24px_rgba(49,112,197,0.22)]"
                        >
                          Download Payslip
                        </button>
                      </div>
